...
const updateValue = (originalEl, clonedEl, modelValue, props, emit, computedOptions) => {
  // Remove old options
  ...
  // Update value
  if (
    (!Array.isArray(modelValue) && modelValue !== clonedEl.TomSelect.getValue()) ||
    (Array.isArray(modelValue) && !_.isEqual(modelValue, clonedEl.TomSelect.getValue()))
  ) {
