...
// import FullCalendar from "./calendar/ProgressBar.vue";
...
import Tree from './tree-view/lib/index';
import NotificationToastify from './notification-toastify/Main.vue';
import VueInputTag from "./vue-tags-input";

//BEGIN: TigerBui` - custom component
import InlineSvg from "vue-inline-svg";
import SvgIcons from "@/global-components/svg-icons/Main.vue";
import ColorsPicker from "@/global-components/colors-picker/Main.vue";
import iNETComponent from '@/global-components/inet-custom/index.vue';
//END: TigerBui` - custom component
...
export default (app) => {
  ...
  app.component('iNETComponent', iNETComponent);
  app.component('colors-picker', ColorsPicker);
  app.component('Tree', Tree);
  app.component('NotificationToastify', NotificationToastify);
  app.component('VueInputTag', VueInputTag);
